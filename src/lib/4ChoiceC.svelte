...
<div id="disaster-picker">
    ...
    <p>Some Townsvillians are sad to miss out on the yearly tradition, but health experts and Townsvillians with immunocompromised friends and family praise the decision.
        <br><br>
        According to a 2021 poll, 83% of the Japanese public would also agree with your decision.
